...
class OrderTest extends BaseApplicationTest
{
    ...
    {
        $response = $this->request('POST', '/api/order');

        self::assertSame(Response::HTTP_UNAUTHORIZED, $response->getStatusCode());
    }

    public function testTryCreateOrderWithoutProducts(): void
    {
        //given
        $params = [
            'productIds' => []
        ...
        self::assertSame('productIds', $response['violations'][0]['propertyPath']);
